...
class CalculateCashService
{
    ...
    public function loadCountTodayIncome(): mixed
    {
        ...
        $currencyMethod = SettingQueries::getSettingValue('currency');

        // Debug
        // var_dump($currencyMethod);

        // return Money::$currencyMethod($todayIncome);
        // return money($todayIncome, $currencyMethod);

        // Return sebagai instance Money
        // return money($todayIncome, $currencyMethod);

        // Atau jika ingin format langsung:
        return money($todayIncome, $currencyMethod)->format();
    }
