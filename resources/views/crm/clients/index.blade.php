                            ...
                            <tr class="bg-white hover:bg-gray-50">
                                ...
                                <td class="px-4 py-2 text-center border border-gray-300">
                                    <button type="submit"
                                        ...
                                        {{ \Cknow\Money\Money::{\App\Queries\SettingQueries::getSettingValue('currency')}($client->budget * 100) }}
                                        <!-- {{ \App\Queries\SettingQueries::getSettingValue('currency') }} {{$client->budget}} -->
                                    </button>
                                </td>
                                <td class="px-4 py-2 text-center border border-gray-300">
